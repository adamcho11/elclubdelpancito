    ...
    <div className="min-h-screen">
      <section className="py-20 bg-gradient-oven border-b border-oven-700/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-cream-dark/70 max-w-xl mx-auto">
            Todo lo que necesitás saber sobre nuestras suscripciones, entregas, pagos y más.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-oven-950">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 text-center p-8 rounded-2xl bg-gradient-card border border-oven-600/20">
            <h3 className="text-cream-light font-semibold text-lg mb-2">
