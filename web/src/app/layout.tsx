...
Tawk_API.onLoad = function(){
  Tawk_API.hideWidget();
  setTimeout(function(){ Tawk_API.showWidget(); }, 300);
  Tawk_API.setAttributes({
    proyecto: 'El Club del Pancito',
    pagina: window.location.pathname
  }, function(error){});
};

Tawk_API.onChatStarted = function(){
  Tawk_API.addTags(["pan-artesanal","suscripcion","Sucre"]);
};

(function(){
var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
s1.async=true;
s1.src='https://embed.tawk.to/6a34846316fcef1d436fb118/1jreia9ri';
s1.charset='UTF-8';
