      ...
      <section className="py-20 bg-gradient-oven border-b border-oven-700/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-cream-dark/70 max-w-xl mx-auto">
            Tres planes con pan artesanal chuquisaqueño a domicilio. Todos incluyen 1 complemento gratis a elección, distinto cada semana.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6">
            {[
              ...
              { title: "Pago seguro con QR Simple", desc: "Pagá escaneando el QR con tu app bancaria. Subí el comprobante y listo. Tus datos nunca se almacenan en nuestros servidores." },
